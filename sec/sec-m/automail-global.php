    ...
    <tbody>";
		...
		while ($rowAlert = pg_fetch_array($resAlert)){
	        ...
	        $body    .= "<tr style=\"margin-bottom:5px;margin-top:5px;\">
	            <td valign=\"top\" width=\"25%\" style = \"font-family: trebuchet MS;border-bottom:0.75px solid #808080; font-size: 10pt;\">".$rowAlert['name'].", ".$rowAlert['location'].", ".$date->format('d-m-Y')." ".$rowAlert['time']."</td>
