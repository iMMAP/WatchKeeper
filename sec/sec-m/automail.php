...
$to = "";
$qry_email_list = "select email from sms_user where email !='' and country_id = 3";
...
// ZuRahman@usaid.gov,rhoornveld@immap.org,gshafi@usaid.gov,APervaiz@usaid.gov";

	// $to      = "bhermansyah@immap.org,rhoornveld@immap.org"; 
